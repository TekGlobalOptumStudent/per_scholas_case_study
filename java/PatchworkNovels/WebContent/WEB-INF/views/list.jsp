            ...
            <div class="col">
                ...
                <div class="list-group">
                	<c:forEach var="i" begin="0" end="${allSnippets.size() - 1}">
						<a href="${pageContext.request.contextPath}/snippet/${allSnippets.get(i).getSnippetId()}"
            ...
            <div class="col">
                ...
                <div class="list-group">
                    <c:forEach var="i" begin="0" end="${allStories.size() - 1}">
						<a href="${pageContext.request.contextPath}/story/${allStories.get(i).getStoryTitle()}"
							class="list-group-item list-group-item-action flex-column align-items-start">
							<div class="d-flex w-100 justify-content-between">
