package com.SpringDataJpaPlayground.config;
...
@EnableJpaRepositories("com.PatchworkNovels.repo")
...
public class DataConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactoryBean() {
		...
		emfBean.setPersistenceUnitName("PatchworkNovels");
		emfBean.setPackagesToScan("com.PatchworkNovels.entities");
